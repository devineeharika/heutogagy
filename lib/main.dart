    ...
    children: <Widget>[
     Container(
             ...
             child:TextField(
               ...
               decoration: InputDecoration(
                      filled: true,
                      fillColor:pressed4?(check21?Colors.green:Colors.red):Colors.white,
                       border: OutlineInputBorder()),
               style: new TextStyle(
      fontSize: 11.0,
    ...
    children: <Widget>[
     Container(
             ...
             child:TextField(
               ...
               decoration: InputDecoration(
                      filled: true,
                      fillColor:pressed7?(check31?Colors.green:Colors.red):Colors.white,
                       border: OutlineInputBorder()),
               style: new TextStyle(
      fontSize: 11.0,
